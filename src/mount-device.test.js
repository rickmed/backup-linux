const {mountDeviceImp, execHandlerImp} = require('./mount-device')
...
describe('external-drives', () => {
  ...
  describe('execHandlerImp', () => {
    ...
    it('should call rmdir and the cb with correct params on execFile err', () => {
      ...
      execHandlerImp(_rmdir)(SOME_PATH, _cb)(SOME_ERR, null, null)
  ...
  describe('mountDevice', () => {
    ...
    it('should call cb with correct err msg on mkdir fail', () => {
      ...
      mountDeviceImp(_execFile, _mkdir)(DEV_NAME, _cb)
      expect(_cb.mock.calls[0][0].mountDevice).toBeDefined()
    });
